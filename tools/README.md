...
# Export Mark 45 without its visual number indicator badge:
python3 tools/export_svg_groups.py src/art-sheet-5-8-23/2023-05-08-art-sheet-01.svg --pattern "^Mark 45$" --no-mark-numbers
